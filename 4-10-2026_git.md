...
1. Click the branch name in the bottom-left status bar → Create new branch…. Use a descriptive name and include your name to know who it came from, like ```pipeline/fastqc_jm```
...
2. Publish your branch to GitHub. With vscode: After creating the branch, click the cloud icon in the status bar 


or on the command line, run:

```
git push -u origin pipeline/fastqc_jm
```
