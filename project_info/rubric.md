...
- Due no later than 5/15/23 (can submit eariler)
- Graded on the sections below (50 points total)

### 50 pts. Project Submission @ Github
- 5 pts. formtting sections/organization
- 5 pts. background (1 or more citations)
- 10 pts. methods (1 or more citations)
- 10 pts. results figure/interpretation (pick a result to highlight)
- 15 pts. reproducibility (code availible)
